    ...
    extends TreeControlBean
{
	...
	{	
		////System.out.println(">>> WOTreeBaseBean initialize hit: " + getId());
		super.initialize();
		if( !_initizialzed )
		{
	...
	{	
        //System.out.println(">>> WOTreeBaseBean selectnode hit.6 1 " + (Thread.currentThread().getStackTrace()[3].toString()) + " ==> " + ((new Object() {}).getClass().getEnclosingMethod().getName()) );
		try
		{				
			//System.out.println(">>> WOTreeBaseBean selectnode 2");
			if(!WebClientRuntime.isNull(uniqueidvalue))
			{
				...
				//System.out.println(">>> WOTreeBaseBean selectnode num: " + num);
	...
	protected void selectItemInModel(
		...
		throws RemoteException, 
		       MXException 
	{
		//System.out.println(">>> WOTreeBaseBean selectItemInModel hit: " + num);
		...
		if( treeMbo == null )
		{
			//System.out.println(">>> WOTreeBaseBean selectItemInModel treeMbo == null");
			return;
		}
		...
		else
		{
 		...
 		{
 			//System.out.println(">>> WOTreeBaseBean selectItemInModel locationEntry == null || locationEntry._mbo == null");
			return;
 		}
		//System.out.println(">>> WOTreeBaseBean selectItemInModel locationEntry._mbo.getUniqueIDValue(): " + locationEntry._mbo.getUniqueIDValue());
    ...
    public void structureChangedEvent(
		...
		////System.out.println(">>> WOTreeBaseBean structureChangedEvent hit");
	...
	{
		////System.out.println(">>> WOTreeBaseBean processLocationChange hit");
        try
        {
    		////System.out.println(">>> WOTreeBaseBean processLocationChange _viewModelLocBean.getMboSet().getCompleteWhere(): " + _viewModelLocBean.getMboSet().getCompleteWhere());
    		////System.out.println(">>> WOTreeBaseBean processLocationChange _viewTreeLocBean.getMboSet().getCompleteWhere(): " + _viewTreeLocBean.getMboSet().getCompleteWhere());
	 		MboRemote mbo = _viewModelLocBean.getMbo();
	 		if( mbo != null )
	 		{
	 			////System.out.println(">>> WOTreeBaseBean processLocationChange mbo != null");
				...
				for( int i = 0; i < count; i++ )
				{
					...
					long uid = treeMbo.getUniqueIDValue();
		 			////System.out.println(">>> WOTreeBaseBean processLocationChange this.getMboForUniqueId(uid): " + uid);
		 			////System.out.println(">>> WOTreeBaseBean processLocationChange location: " + location);
		 			////System.out.println(">>> WOTreeBaseBean processLocationChange siteid: " + siteId);
...
//					if( ctrl != null )
//					{
//						////System.out.println(">>> WOTreeBaseBean processLocationChange firing alpha re-render start8");
//						//ctrl.reInitialize();
//						//ctrl.render();
////						ctrl.renderChildren();
//						//ctrl.setChangedFlag();
...
//						
//						((AssetLookupBase) _viewTreeLocBean).setCurrentBeanRecord(location);
//						((AssetLookupBase) _viewTreeLocBean).fireDataChangedEvent();
//						
////						((WOModelLocBean) _viewModelLocBean).setCurrentBeanRecord(location);
////						((WOModelLocBean) _viewModelLocBean).fireDataChangedEvent();
//						
//						
////						if(_viewer != null)
////						{
////							_viewer.setChangedFlag();
////						} else {
////							////System.out.println(">>> WOTreeBaseBean processLocationChange _viewer control was null");
////						}
////						////System.out.println(">>> WOTreeBaseBean processLocationChange firing alpha re-render end");
//					}
//					ctrl = wcs.findControl( "view_location1" );
//					if( ctrl != null )
//					{
//						////System.out.println(">>> WOTreeBaseBean processLocationChange location control where: " + ctrl.getDataBean().getMboSet().getCompleteWhere());
//						MboRemote locmbo = ctrl.getDataBean().getMboSet().getMbo();
//						if(locmbo != null)
//						{
//							ctrl.getDataBean().fireDataChangedEvent();
////							ctrl.setChangedFlag();
...
//						}
//					}
//					ctrl = wcs.findControl( "view_description" );
//					if( ctrl != null )
//					{
//						////System.out.println(">>> WOTreeBaseBean processLocationChange location desc control where: " + ctrl.getDataBean().getMboSet().getCompleteWhere());
//						MboRemote locmbo = ctrl.getDataBean().getMboSet().getMbo();
//						if(locmbo != null)
//						{
//							ctrl.getDataBean().fireDataChangedEvent();
...
//						}
//					}
//					ctrl = wcs.findControl( "model_location_1_3" );
//					if( ctrl != null )
//					{
//						////System.out.println(">>> WOTreeBaseBean processLocationChange siteid control where: " + ctrl.getDataBean().getMboSet().getCompleteWhere());
//						MboRemote locmbo = ctrl.getDataBean().getMboSet().getMbo();
//						if(locmbo != null)
//						{
//							ctrl.getDataBean().fireDataChangedEvent();
...
//						}
//					}
////					ctrl = wcs.findControl( CTRL_VIEW_LOC );
////					if( ctrl != null )
////					{
////						////System.out.println(">>> WOTreeBaseBean processLocationChange viewer control resets hit");
////						ctrl.getBoundComponent().hasChanged();
////						ctrl.hasChanged();
////						ctrl.getBoundComponent().render();
////						ctrl.getBoundComponent().getControl().setNeedsRender(true);
////						ctrl.getBoundComponent().getControl().render();
////						////System.out.println(">>> WOTreeBaseBean processLocationChange viewer control resets end");
////					}
//					
					match = true;
					break;					
        ...
        {
    		////System.out.println(">>> WOTreeBaseBean processLocationChange exception");
	        e.printStackTrace();	// Ignore - nothing we can do
        }
		////System.out.println(">>> WOTreeBaseBean processLocationChange end");
	}
    ...
    protected MboSetRemote getMboSetRemote() 
		throws MXException, 
		       RemoteException
	{
		////System.out.println(">>> WOTreeBaseBean getMboSetRemote hit");
		...
		if( _treeSet != null )
		{
			////System.out.println(">>> WOTreeBaseBean _treeSet != null");
			return _treeSet;
		}
		...
		if( appMbo == null )
		{
			////System.out.println(">>> WOTreeBaseBean appMbo == null");
			return null;
		}
		...
		_treeSet = (BIMWorkOrderTreeSetRemote)server.getMboSet( BIMWorkOrderTree.TABLE_IMWOTREE, 
		                                                        userInfo );
		////System.out.println(">>> WOTreeBaseBean end");
		return _treeSet;
	}
	...
	protected void populateTreeNode(
		...
		throws RemoteException, 
		       MXException 
	{
		////System.out.println(">>> WOTreeBaseBean populateTreeNode hit");
	...
	{
		////System.out.println(">>> WOTreeBaseBean populatePathToTop hit");
 	...
 	protected CacheEntry lookupLocation(
 		...
 		throws RemoteException, 
 		       MXException 
 	{
		////System.out.println(">>> WOTreeBaseBean lookupLocation hit");
 	...
 	protected CacheEntry lookupAsset(
 		...
 		throws RemoteException, 
 		       MXException 
 	{
		////System.out.println(">>> WOTreeBaseBean lookupAsset hit");
 	...
 	protected class CacheEntry
 	{
 		...
 		CacheEntry(
 			...
 			////System.out.println(">>> WOTreeBaseBean CacheEntry hit");
 		...
 		String getKey()
 		{
 			////System.out.println(">>> WOTreeBaseBean CacheEntry.getKey hit");
