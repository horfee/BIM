    ...
    extends DataBean
{
	...
	{
        //System.out.println(">>> AssetLookupBaseToo bean " + (Thread.currentThread().getStackTrace()[3].toString()) + " ==> " + ((new Object() {}).getClass().getEnclosingMethod().getName()) );
		       ...
		       MXException
	{
		...
		{
			////System.out.println(">>> AssetLookupBaseToo o == null || !(o instanceof String");
		...
		{
			////System.out.println(">>> AssetLookupBaseToo modelLocation.length() == 0");
			return WebClientBean.EVENT_HANDLED;
		}
	...
	public void setCurrentBeanRecord(String modelLocation) throws RemoteException, MXException
	{
		...
		locationSet.reset();
		//System.out.println(">>> AssetLookupBaseToo select locationsid, location, siteid, orgid from locations where " + locationSet.getCompleteWhere());
	...
	{
        //System.out.println(">>> AssetLookupBaseToo bean " + (Thread.currentThread().getStackTrace()[3].toString()) + " ==> " + ((new Object() {}).getClass().getEnclosingMethod().getName()) );
		////System.out.println(">>> AssetLookupBase setCurrentBeanRecordByLocId hit: " + locationId);
		getMboSet().getMboForUniqueId(locationId);
		////System.out.println(">>> AssetLookupBase setCurrentBeanRecordByLocId end");
	}
